...
job_sv = statevector_simulator.run(transpile(qc, statevector_simulator, optimization_level=0))
result_sv = job_sv.result()
statevector = partial_trace(result_sv.get_statevector(), [0, 1, 3, 4, 5]).to_statevector()
print(statevector)